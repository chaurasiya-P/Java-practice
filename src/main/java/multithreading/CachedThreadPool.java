...
public class CachedThreadPool {
    ...
    public static void main(String[] args) {
        ...
        // but will reuse previously constructed threads when
        // they are available. Calls to execute will reuse previously
        // constructed threads if available. If no existing
        // thread is available, a new thread will be created and added to the pool
